...
class ExerciseController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('createMy', 'update', 'deleteMy'),
                'users' => array('@'),
            ),
    ...
    public function actionCreateMy() {
        ...
        if (isset($_POST['name'])&&isset($_POST['instruction'])) {
    ...
    public function actionDeleteMy() {
        $id = $_POST['id'];
        $model = $this->loadModel($id);
    ...
    public function actionIndex() {
        $server_exercises = Exercise::model()->findAll(array('condition' => 'user_id IS NULL'));
        
       
            
            
        $user_exercises = Exercise::model()->findAll(array('condition' => 'user_id='.Yii::app()->user->id));
        $dataProvider = new CActiveDataProvider('Exercise');
        $this->render('index', array(
            'server_exercises' => $server_exercises,
